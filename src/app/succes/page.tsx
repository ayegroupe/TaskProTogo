    ...
    <div className="bg-white min-h-screen py-24 px-4">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-gray-50 p-8 rounded-3xl text-left border border-gray-100 group hover:bg-white hover:shadow-xl hover:-translate-y-2 transition-all duration-300 hover:border-emerald-200">
            <div className="flex gap-1 mb-4 text-amber-400 group-hover:scale-105 transition-transform origin-left"><Star className="fill-current w-5 h-5"/><Star className="fill-current w-5 h-5"/><Star className="fill-current w-5 h-5"/><Star className="fill-current w-5 h-5"/><Star className="fill-current w-5 h-5"/></div>
            ...
            <div className="font-bold text-gray-900 group-hover:text-emerald-600 transition-colors">Komi D.</div>
          ...
          <div className="bg-gray-50 p-8 rounded-3xl text-left border border-gray-100 group hover:bg-white hover:shadow-xl hover:-translate-y-2 transition-all duration-300 hover:border-emerald-200">
            ...
            <div className="font-bold text-gray-900 group-hover:text-emerald-600 transition-colors">Sarah B.</div>
          ...
          <div className="bg-gray-50 p-8 rounded-3xl text-left border border-gray-100 group hover:bg-white hover:shadow-xl hover:-translate-y-2 transition-all duration-300 hover:border-emerald-200">
            ...
            <div className="font-bold text-gray-900 group-hover:text-emerald-600 transition-colors">Kodjo E.</div>
